...
const PAGES = {
  ...
  'Ecosophy For Her.dc.html': {
    route: 'for-her.html',
    title: 'Ecosophy Beauty Lounge — Dubai',
  ...
  'Ecosophy For Him.dc.html': {
    route: 'for-him.html',
    title: 'Ecosophy Aesthetic Spa — Dubai',
  ...
  'Ecosophy Services.dc.html': {
    ...
    description: 'The full treatment menu for Ecosophy Beauty Lounge, Dubai — massage, hammam, facials and body rituals.',
    mark: 'favicons/mark-woman-gold-180.png',
  },
  'Ecosophy Service Detail.dc.html': {
    route: 'service.html',
    title: 'Treatment — Ecosophy Beauty Lounge',
    description: 'Treatment details and duration at Ecosophy Beauty Lounge, Dubai.',
    mark: 'favicons/mark-woman-gold-180.png',
  },
  'Ecosophy Gent Services.dc.html': {
    route: 'gent-services.html',
    title: 'Treatment Menu — Ecosophy Aesthetic Spa',
    description: 'The full treatment menu for Ecosophy Aesthetic Spa, Dubai — massage, hammam, skin and grooming.',
    mark: 'favicons/mark-man-gold-180.png',
  },
  'Ecosophy Gallery.dc.html': {
    route: 'gallery.html',
    video: 'gal-video.mp4',
    title: 'Gallery — Ecosophy Beauty Lounge, Dubai',
  ...
  'Ecosophy Gent Gallery.dc.html': {
    ...
    title: 'Gallery — Ecosophy Aesthetic Spa, Dubai',
  ...
  'Ecosophy Book.dc.html': {
    route: 'book.html',
    title: 'Book a Visit — Ecosophy Beauty Lounge, Dubai',
    description: 'Request a treatment at Ecosophy Beauty Lounge, Dubai — choose your ritual, day and time, and confirm on WhatsApp.',
    mark: 'favicons/mark-woman-gold-180.png',
  },
  'Ecosophy Gent Book.dc.html': {
    route: 'gent-book.html',
    title: 'Book a Visit — Ecosophy Aesthetic Spa, Dubai',
    description: 'Request a treatment at Ecosophy Aesthetic Spa, Dubai — choose your ritual, day and time, and confirm on WhatsApp.',
    mark: 'favicons/mark-man-gold-180.png',
  },
  'Ecosophy Gent Service Detail.dc.html': {
    route: 'gent-service.html',
    title: 'Treatment — Ecosophy Aesthetic Spa',
    description: 'Treatment details and duration at Ecosophy Aesthetic Spa, Dubai.',
    mark: 'favicons/mark-man-gold-180.png',
  },
};
